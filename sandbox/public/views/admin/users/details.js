...
(function() {
  ...
  app.IdentityView = Backbone.View.extend({
    ...
    render: function() {
      ...
      this.$el.find('.isActive').bootstrapSwitch();
    },
    update: function() {
      this.model.save({
  ...
  app.RolesView = Backbone.View.extend({
    ...
    render: function() {
      ...
      this.$el.find('.isMentor').bootstrapSwitch();
    },
    adminOpen: function() {
    ...
    updateIsMentor: function() {
        this.model.save({
            mentor: this.$el.find('.isMentor').bootstrapSwitch('status')
        }, {
            url: this.model.url() + '/role-mentor'
        });
    }
  });
