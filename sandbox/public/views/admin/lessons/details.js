...
app.Delete = Backbone.Model.extend({
    ...
    url: function() {
        return '/admin/lessons/' + app.mainView.model.id;
    }
});
...
app.More = Backbone.Model.extend({
    ...
    url: function() {
        return '/admin/programs/findNoLesson';
    }
});
...
app.Program = Backbone.Model.extend({
    ...
    url: function() {
        return '/admin/lessons/' + app.mainView.model.id + '/programs';
    },
    parse: function(response) {
        if (response.lesson) {
            app.mainView.model.set(response.lesson);
