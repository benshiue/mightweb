...
var _vv =
{
    ...
    "play": {
        "buttons": {
            ...
            "green": { "title": "Full Screen", "state": "play-fullscreen", "callback": myToggleFullScreen },
            "blue": { "title": "Share to Friends", "state": null, "callback": null }
        }
    },

    "play-fullscreen": {
        "buttons": {
            "red" : { "title": "Stop Video", "state": "prepared-fullscreen", "callback": myVideoStop },
            "yellow" : { "title": "Pause Video", "state": "prepared-fullscreen", "callback": myVideoPause },
            "green": { "title": "Exit FullScreen", "state": "play", "callback": myToggleFullScreen },
            "blue": { "title": "Share to Friends", "state": null, "callback": null }
        }
    },
    ...
    "prepared-fullscreen": {
        "buttons": {
            "red" : { "title": "Play Video", "state": "play-fullscreen", "callback": myVideoPlay },
            "yellow" : { "title": "---", "state": null, "callback": null },
            "green": { "title": "Exit FullScreen", "state": "prepared", "callback": myToggleFullScreen },
            "blue": { "title": "---", "state": null, "callback": null }
        }
    },
};
